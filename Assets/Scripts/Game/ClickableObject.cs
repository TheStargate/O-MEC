...
public class ClickableObject : MonoBehaviour
{
    ...
    [HideInInspector] public Vector3 offsetDelObjetoClickable = new Vector3(0, 10f, -5f); // Posición relativa donde se debe quedar la cámara al seleccionar el objeto
